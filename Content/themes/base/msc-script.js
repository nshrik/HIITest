(function(){
    ...
    function buildUI(title, sub, onOk, onCancel, type, okText, cancelText) {
    ...
    window.mscConfirmYesNo = function (title, sub, onOk, onCancel) {
        buildUI(title, sub, onOk, onCancel, "confirm","Yes","No");
    };
